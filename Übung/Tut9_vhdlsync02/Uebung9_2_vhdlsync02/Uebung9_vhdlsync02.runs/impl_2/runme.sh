...
HD_PWD='/zwork/Uebung9__vhdlsync02/Uebung9_vhdlsync02.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log MODULE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MODULE.tcl -notrace
