...
HD_PWD='/zwork/Uebung9__vhdlsync02/Uebung9_vhdlsync02.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log MODULE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MODULE.tcl
